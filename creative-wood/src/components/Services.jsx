...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-white font-medium text-7xl text-center justify-center tracking-[0.2em] hidden md:block" style={{ transform: 'translateY(8rem)' }}>USLUGE</h1></div>
      <div className="flex md:items-end lg:gap-0 justify-center h-screen">
      
        <div className="items-center md:justify-items-center mt-12 justify-center md:grid-cols-3 md:gap-x-[2rem] lg:gap-x-[8rem] md:gap-y-2 gap-y-[1.4rem] md:grid flex-cols-3 flex flex-col lg:gap-6">
        
      <h1 className="text-white font-medium text-4xl  text-center tracking-[0.2em] block md:hidden">USLUGE</h1>
          ...
          <h2 className="text-base font-bold text-white block md:hidden">Izrada Anime LED Lampi</h2>
          ...
          <h2 className="text-base font-bold text-white block md:hidden">Izrada Zidnih Satova</h2>
          ...
          <h2 className="text-base font-bold text-white block md:hidden md:mb-0 mb-10">Izrada LED Lampi</h2>
